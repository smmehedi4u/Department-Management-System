                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form :action=" route('teacher.publication.store')" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-6">
                            ...
                            <input autofocus="true" type="string" id="address" name="address" value="{{ old('address') }}"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  @error('address') bg-red-50 border-red-500 text-red-900 placeholder-red-700 focus:ring-red-500 @enderror  "
                            required="">
